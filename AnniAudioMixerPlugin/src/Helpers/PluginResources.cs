namespace Loupedeck.AnniAudioMixerPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.AnniAudioMixerPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.AnniAudioMixerPlugin.Resources.Resource.txt`.
